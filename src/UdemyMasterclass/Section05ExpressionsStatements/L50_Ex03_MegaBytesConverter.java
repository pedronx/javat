...
public class L50_Ex03_MegaBytesConverter {
    ...
    /**
     * Calculates the megabytes and remaining kilobytes from the "kilobytes" parameter.
     * Pints a message in the format "XX KB = YY MB and ZZ KB"
     */
