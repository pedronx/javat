 ...
 * You have to write a program that helps Bob calculate how many
 * buckets of paint he needs to buy before going to work.
 ...
 * If one of the parameter's width, height or areaPerBucket is less or equal to 0 or if extraBuckets is less than 0,
 ...
 */
public class L74_Ex29_PaintJob {

    public static void main (String[] args) {

        System.out.println("getBucketCount(-3.4, 2.1, 1.5, 2) = " + getBucketCount(-3.4, 2.1, 1.5, 2));
        System.out.println("getBucketCount0, 2.1, 1.5, 2) = " + getBucketCount(0, 2.1, 1.5, 2));
        System.out.println("getBucketCount(3.4, 2.1, 1.5, 2) = " + getBucketCount(3.4, 2.1, 1.5, 2));
        System.out.println("getBucketCount(1.4, 2.1, 1.5, 2) = " + getBucketCount(1.4, 2.1, 1.5, 2));
        ...
        System.out.println("getBucketCount(0, 2.1, 1.5) = " + getBucketCount(0, 2.1, 1.5));
        System.out.println("getBucketCount(3.4, 2.1, 1.5) = " + getBucketCount(3.4, 2.1, 1.5));
        ...
        System.out.println("getBucketCount(0, 1.5) = " + getBucketCount(0, 1.5));
        System.out.println("getBucketCount(3.4, 1.5) = " + getBucketCount(3.4, 1.5));
    ...
    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
        ...
        // Calculate the area of the wall (A = w * h)
        double areaWall = width * height;

        // calculate how many area the extraBuckets will cover
        areaWall -= (extraBuckets * areaPerBucket);

        if (areaWall <= 0) {
            return 0;
        }

        return ((int)Math.ceil(areaWall / areaPerBucket));
    }
