 ...
 */
public class L71_Ex25_FlourPacker {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("canPack (3, 2, 11) = " + canPack (3, 2, 11));
    ...
    public static boolean canPack(int bigCount, int smallCount, int goal) {
        ...
        // verify the bigCount flower bags (5 Kg)
        ...
        // verify the smallCount flower bags (1 Kg)
