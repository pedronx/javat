 ...
 * using a loop and return the sum of the first and the last digit of thatnumber.
 ...
 */
public class L69_Ex17_FirstLastDigitSum {
    ...
    public static int sumFirstAndLastDigit (int number) {
        int sumOfDigits = 0, lastDigit = 0;

        if (number < 0) {
            return -1;
        }

        lastDigit += number % 10; // extract and sum the last digit of num
