 ...
 */
public class L69_Ex22_GreatestCommonDivisor {

    public static void main (String[] args) {
        System.out.println("getGreatestCommonDivisor(12, 24) = " + getGreatestCommonDivisor(12, 24));
        System.out.println("getGreatestCommonDivisor(12, 18) = " + getGreatestCommonDivisor(12, 18));
        ...
        System.out.println("getGreatestCommonDivisor(10, 9) = " + getGreatestCommonDivisor(10, 9));
        System.out.println("getGreatestCommonDivisor(81, 153) = " + getGreatestCommonDivisor(81, 153));
        System.out.println("getGreatestCommonDivisor(256, 32) = " + getGreatestCommonDivisor(256, 32));
    }

    public static int getGreatestCommonDivisor(int first, int second) {
        int divisor = 0, firstDivisor = 0, secondDivisor = 0;

        if (first < 10 || second < 10) {
            return -1;
        }

        int min = Math.min(first, second); // find the minimum of 2 integers, to start the loop
        for (int i = min; i > 0; i--) {
