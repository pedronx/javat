 ...
 * >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
 * Write a second method getDaysInMonth with two parameters month and year. Both of type int.
...
public class L59_Ex2_NumberOfDaysInMonth {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("getDaysInMonth(-1, 2020) : " + getDaysInMonth(-1, 2020));
        System.out.println("getDaysInMonth(1, -2020) : " + getDaysInMonth(1, -2020));
        System.out.println("getDaysInMonth(2, 2000) : " + getDaysInMonth(2, 2000));
