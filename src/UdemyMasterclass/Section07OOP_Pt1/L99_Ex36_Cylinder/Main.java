package UdemyMasterclass.Section07OOP_Pt1.L99_Ex36_Cylinder;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("circle.radius= " + anotherCircle.getRadius());
        System.out.println("circle.area= " + anotherCircle.getArea());
        Cylinder anotheCylinder = new Cylinder(-1, 7.25);
        System.out.println("cylinder.radius= " + anotheCylinder.getRadius());
        System.out.println("cylinder.height= " + anotheCylinder.getHeight());
        System.out.println("cylinder.area= " + anotheCylinder.getArea());
        System.out.println("cylinder.volume= " + anotheCylinder.getVolume());
